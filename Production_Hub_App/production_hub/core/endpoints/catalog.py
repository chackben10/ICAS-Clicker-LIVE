...
ACTION_SPECS: tuple[ActionSpec, ...] = (
    ...
    ActionSpec(
        "propresenter.get_focused_playlist",
        "Get Focused Playlist",
        "ProPresenter",
        "Return the currently focused ProPresenter playlist and item.",
        path=("Read / Data Modules", "ProPresenter"),
    ),
    ActionSpec(
        "propresenter.get_playlist_by_uuid",
        "Get Playlist by UUID",
        "ProPresenter",
        "Return one ProPresenter playlist by UUID.",
        (FieldSpec("uuid", "Playlist UUID", "text", "", "Use a UUID, or a variable such as {{uuid}}."),),
        ("Read / Data Modules", "ProPresenter"),
    ),
    ...
    ActionSpec(
        ...
        "Trigger Playlist Presentation Slide",
        "ProPresenter",
        "Trigger a slide in an eligible presentation item while preserving playlist focus.",
        (
            FieldSpec("playlist_uuid", "Playlist UUID", "text", "", "Use a UUID, or a variable such as {{playlist_uuid}}."),
            FieldSpec("item_index", "Playlist item index", "text", "0", "Use a number, or a variable such as {{item_index}}."),
            FieldSpec("slide_index", "Slide index", "text", "0", "Use a number, or a variable such as {{slide_index}}."),
        ),
        ("ProPresenter Actions", "Slide Control Actions"),
    ),
    ActionSpec(
